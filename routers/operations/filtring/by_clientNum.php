...
$sql = "SELECT * FROM operations WHERE client_number = '$client_number' ORDER BY id DESC LIMIT $records_per_page OFFSET $offset";
...
if ($result->num_rows > 0) {
    ...
    $sql_count = "SELECT COUNT(*) AS total_records FROM operations WHERE client_number = '$client_number'";
